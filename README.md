...
An exploratory project on the Vulkan API (using v.1.4 features) by implementing a Minecraft like game as the goal.  
As of now, the project has only been tested on Windows 11 and developed using Visual Studio 2022.  

![Screenshot of the current terrain generation](/images/screenshot.jpg)
...
## Potential dependencies to install
- [GLFW dependencies](https://www.glfw.org/docs/latest/compile.html); may need to install additional packages if your build is failing, such as not having Wayland.
- [Vulkan SDK](https://www.lunarg.com/vulkan-sdk/) (tested with v.1.4.303); for development

## Included dependencies (don't install)
...
- [spdlog](https://github.com/gabime/spdlog) (v.1.17.0)
